...
async def scrape_product(url: str):
    ...
    if store is None:
        return {
            "success": False, "url": url, "platform": "unsupported", "product_name": "",
            "price": "", "price_value": None, "currency": "VND", "availability": "unknown",
    ...
    try:
        ...
        return {
            "success": False, "url": url, "platform": store, "product_name": "",
            "price": "", "price_value": None, "currency": "VND", "availability": "unknown",
    ...
    if price_value is None:
        return {
            "success": False, "url": url, "platform": store, "product_name": product_name,
            "price": "", "price_value": None, "currency": "VND", "availability": "unknown",
            "error": "Khong tim thay gia tren trang.",
        }

    return {
        "success": True, "url": url, "platform": store, "product_name": product_name,
        "price": price_text, "price_value": price_value, "currency": "VND",
        "availability": "unknown", "error": None,
    }
